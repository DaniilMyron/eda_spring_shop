...
public class ObjectToProductConverter {
    public static Product productFromPayload(JSONObject payload) {
    ...
    public static ProductInCart productToCartFromPayload(final JSONObject payload, int payloadCount, Cart cart) {
